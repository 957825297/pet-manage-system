...
<el-table-column align= 'center' prop="packing" label="包装规格" width="140"></el-table-column>
...
<el-dialog title="修改" :visible.sync="dialogFormVisible">
  ...
  <el-form-item label="商品类别">
    <el-select v-model="form.class" placeholder="请选择服务类别">
   ...
   <el-form-item label="适用规格">
    ...
    <el-input type="text" class="input" v-model="form.locality"></el-input>元
  </el-form-item>
</el-form>
